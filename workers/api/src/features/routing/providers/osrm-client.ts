...
export function getOSRMOptions(env: { OSRM_BASE_URL?: string }): OSRMOptions {
  return {
    baseUrl: env.OSRM_BASE_URL || OSRM_CONFIG.DEFAULT_BASE_URL,
    connectTimeoutMs: OSRM_CONFIG.CONNECT_TIMEOUT_MS,
    requestTimeoutMs: OSRM_CONFIG.REQUEST_TIMEOUT_MS,
    retries: OSRM_CONFIG.RETRIES,
  }
}
