...
// Rate limiting constants from centralized config
export const RATE_LIMIT_MAX = RATE_LIMIT_CONFIG.MAX_REQUESTS
export const RATE_LIMIT_WINDOW = RATE_LIMIT_CONFIG.WINDOW_SECONDS
